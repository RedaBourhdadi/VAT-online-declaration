...
<head>
    ...
    <link href="{{ asset('css/dragndrop.table.columns.css')}}" rel="stylesheet" />
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css" rel="stylesheet" />
...
<body class="hold-transition sidebar-mini layout-fixed" onload="compart()">
    <div class="wrapper">
        <!-- Main Header -->
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2022 <a href="https://reda-dev.ml/">reda-dev</a>.</strong> All rights
            reserved.
        </footer>
    </div>
